...
md`## 結論
### 從上圖中，我們可以看出：
- ###  大約一半的受訪者在北部工作，其次是南部，接著是中部和東部。
- ###  大多數人認為以數位形式舉辦藝文展覽是一種有效降低碳排放的方式。
- ###  但對於以數位形式舉辦藝文展覽是否能降低碳排放的問題，有一部分的受訪者表示他們尚不清楚或缺乏相關資訊，這顯示有必要進行更多的推廣和提供相關資訊。。
- ###  建議以數位形式舉辦藝文展覽，包括利用數位展示平台、提供虛擬參與、採用可持續材料、提高能源效能，以及數位化宣傳，以最大程度降低碳排放，同時擴大參與範圍。`
)}
...
d3
  .scaleOrdinal()
  .domain(["北部", "東部", "中部", "南部", "是", "否" , "不清楚，需要更多資訊。"])
  .range(["#ECEBE4", "#D3D5D4", "#878E99", "#82A6B1", "#C9CEBD", "#9DB5B2", "#9DB5B2"])
  .unknown("#F1F2F6")
)}
